...
suez_master <-read.table(file = "../Autologous_FMT/Data/Suez_stool_kegg_module_master.txt",
...
# Read in master table
pal_master <- read.table("../Antibiotic_Palleja/My_ngless_result/Palleja_stool_kegg_module_master.txt", header = T, sep = "\t")
...
#write.table(dist_df_long_same, "Palleja_Suez_kegg_module_rarefy495663_bray_vegdist.txt", sep = "\t",
